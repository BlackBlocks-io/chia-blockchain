...
class DBWrapper2:
    ...
    @contextlib.asynccontextmanager
    async def new_transaction(self) -> AsyncIterator[aiosqlite.Connection]:
        """
        ...
        If this transaction fails (by existing the context manager with an
        ...
        The sqlite feature this relies on is SAVEPOINT, ROLLBACK TO and RELEASE.
        """
